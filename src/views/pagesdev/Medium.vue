        ...
        <div class="grid">
            ...
            <div class="col-6">
                ...
                <DataTable :value="medium.individuals" size="small">
                    ...
                    <Column field="taxon_order_by_human" header="物種">
                        <template #body="slotProps">
                            {{ species[slotProps.data.taxon_order_by_human].chinese_common_name }}
                        </template>
                    </Column>
...
const MediumUrl = `${perchMountUrl}/sections/${route.params.section_id}/media/${route.params.medium_id}`

breadcrumbItems.value = [
    { label: null, to: projectUrl },
    { label: null, to: perchMountUrl },
    { label: null, to: sectionUrl },
    { label: null, to: MediumUrl },
]
...
getMediumByID(route.params.medium_id).then(data => {
    medium.value = data
    species.value = data.species
    breadcrumbItems.value[3].label = medium.value.medium_id
})
