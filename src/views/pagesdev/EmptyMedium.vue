...
const emptyMediumUrl = `${perchMountUrl}/sections/${route.params.section_id}/empty_media/${route.params.empty_medium_id}`
...
getEmptyMediumByID(route.params.empty_medium_id).then(data => {
    medium.value = data
    breadcrumbItems.value[3].label = medium.value.empty_medium_id
})
