...
export function getPerchMounts(project = null, habitat = null, terminated = null, claim_by = null) {
    ...
    var endPoint = new URL(`${import.meta.env.VITE_BACKEND_HOST}/perch_mounts/`)
...
export function getPerchMountByID(perchMountID) {
    var endPoint = new URL(`${import.meta.env.VITE_BACKEND_HOST}/perch_mounts/${perchMountID}/`)
    return fetchWithloginCheck(endPoint.href, "GET")
}
...
export function getMediaCount(perchMountID) {
    var endPoint = new URL(`${import.meta.env.VITE_BACKEND_HOST}/perch_mounts/${perchMountID}/media_count`)
    return fetchWithloginCheck(endPoint.href, "GET")
}

export function getPerchMountPending() {
    var endPoint = new URL(`${import.meta.env.VITE_BACKEND_HOST}/perch_mounts/pending`)
    return fetchWithloginCheck(endPoint.href, "GET")
}